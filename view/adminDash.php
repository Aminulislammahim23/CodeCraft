  ...
  <header>
    ...
    <div style="display:flex; align-items:center; margin-bottom:20px;">
       <img src="../<?= htmlspecialchars($avatarPath) ?>" width="100" height="60" style="border-radius:50%">
        <h2 style="font-size:18px; margin:0;">Admin Dashboard</h2>
    </div>
...
<div class="card section" id="export" style="display:none;">
  <h3>📥 Export Annual Revenue Data</h3>
  <form action="../controller/exportRevenue.php" method="POST">
